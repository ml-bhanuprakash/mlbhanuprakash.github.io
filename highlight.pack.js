...
contains:[k]},O=(e,n,t={})=>{const i=a({scope:"comment",begin:e,end:n,
...
},M=O("//","$"),S=O("/\\*","\\*/"),C=O("#","$");var T=Object.freeze({
...
return n?Number(n):(e=>F.includes(e.toLowerCase()))(e)?0:1}const U={},q=e=>{
...
Z;G(e,e.end,{key:"endScope"}),e.end=h(e.end,{joinWith:""})}})(e)}function X(e){
function n(n,t){
...
;[D,L,W,$].forEach((e=>e(r,s))),e.compilerExtensions.forEach((e=>e(r,s))),
...
i=e,a=n),void 0===t&&(t=!0);const r={code:a,language:i};A("before:highlight",r)
;const s=r.result?r.result:h(r.language,r.code,t)
;return s.code=r.code,A("after:highlight",s),s}function h(e,t,i,r){
const c=Object.create(null);function l(){if(!A.keywords)return void M.addText(S)
;let e=0;A.keywordPatternRe.lastIndex=0;let n=A.keywordPatternRe.exec(S),t=""
;for(;n;){t+=S.substring(e,n.index)
;const i=v.case_insensitive?n[0].toLowerCase():n[0],r=(a=i,A.keywords[a]);if(r){
const[e,a]=r
...
;t+=S.substring(e),M.addText(t)}function g(){null!=A.subLanguage?(()=>{
if(""===S)return;let e=null;if("string"==typeof A.subLanguage){
if(!a[A.subLanguage])return void M.addText(S)
;e=h(A.subLanguage,S,!0,O[A.subLanguage]),O[A.subLanguage]=e._top
}else e=E(S,A.subLanguage.length?A.subLanguage:null)
;A.relevance>0&&(C+=e.relevance),M.__addSublanguage(e._emitter,e.language)
})():l(),S=""}function m(e,n){
...
value:A}}),A}function b(e,t,a){let i=((e,n)=>{const t=e&&e.exec(n)
;return t&&0===t.index})(e.endRe,a);if(i){if(e["on:end"]){const a=new n(e)
;e["on:end"](t,a),a.isMatchIgnored&&(i=!1)}if(i){
for(;e.endsParent&&e.parent;)e=e.parent;return e}}
if(e.endsWithParent)return b(e.parent,t,a)}function _(e){
return 0===A.matcher.regexIndex?(S+=e[0],1):(D=!0,0)}function f(e){
const n=e[0],a=t.substring(e.index),i=b(A,e,a);if(!i)return ee;const r=A
;A.endScope&&A.endScope._wrap?(g(),
m(n,A.endScope._wrap)):A.endScope&&A.endScope._multi?(g(),
u(A.endScope,e)):r.skip?S+=n:(r.returnEnd||r.excludeEnd||(S+=n),
g(),r.excludeEnd&&(S=n));do{
A.scope&&M.closeNode(),A.skip||A.subLanguage||(C+=A.relevance),A=A.parent
}while(A!==i.parent);return i.starts&&p(i.starts,e),r.returnEnd?0:n.length}
...
;throw e.mode=A,e}if("end"===r.type){const e=f(r);if(e!==ee)return e}
...
;const k=X(v);let x="",A=r||k;const O={},M=new d.__emitter(d);(()=>{const e=[]
;for(let n=A;n!==v;n=n.parent)n.scope&&e.unshift(n.scope)
;e.forEach((e=>M.openNode(e)))})();let S="",C=0,T=0,R=0,D=!1;try{
if(v.__emitTokens)v.__emitTokens(t,M);else{for(A.matcher.considerAll();;){
R++,D?D=!1:A.matcher.considerAll(),A.matcher.lastIndex=T
...
value:x,relevance:C,illegal:!1,_emitter:M,_top:A}}catch(n){
if(n.message&&n.message.includes("Illegal"))return{language:e,value:Y(t),
illegal:!0,relevance:0,_illegalBy:{message:n.message,index:T,
context:t.slice(T-100,T+100),mode:n.mode,resultSoFar:x},_emitter:M};if(s)return{
language:e,value:Y(t),illegal:!1,relevance:0,errorRaised:n,_emitter:M,_top:A}
...
}),A("after:highlightElement",{el:e,result:r,text:a})}let w=!1;function v(){
...
;return n&&!n.disableAutodetect}function A(e,n){const t=e;r.forEach((e=>{
...
H("10.7.0","Please use highlightElement now."),y(e)),configure:e=>{d=J(d,e)},
initHighlighting:()=>{
...
s=!1},t.safeMode=()=>{s=!0},t.versionString="11.11.1",t.regex={concat:p,
...
}},i={$pattern:be,keyword:_e,literal:fe,built_in:ve,"variable.language":we
...
scope:"attr",match:t+n.lookahead(":"),relevance:0},O,{
...
const ke=e=>p(/\b/,e,/\w$/.test(e)?/\b/:/\B/),xe=["Protocol","Type"].map(ke),Ae=["init","self"].map(ke),Oe=["Any","Self"],Me=["actor","any","associatedtype","async","await",/as\?/,/as!/,"as","borrowing","break","case","catch","class","consume","consuming","continue","convenience","copy","default","defer","deinit","didSet","distributed","do","dynamic","each","else","enum","extension","fallthrough",/fileprivate\(set\)/,"fileprivate","final","for","func","get","guard","if","import","indirect","infix",/init\?/,/init!/,"inout",/internal\(set\)/,"internal","in","is","isolated","nonisolated","lazy","let","macro","mutating","nonmutating",/open\(set\)/,"open","operator","optional","override","package","postfix","precedencegroup","prefix",/private\(set\)/,"private","protocol",/public\(set\)/,"public","repeat","required","rethrows","return","set","some","static","struct","subscript","super","switch","throws","throw",/try\?/,/try!/,"try","typealias",/unowned\(safe\)/,/unowned\(unsafe\)/,"unowned","var","weak","where","while","willSet"],Se=["false","nil","true"],Ce=["assignment","associativity","higherThan","left","lowerThan","none","right"],Te=["#colorLiteral","#column","#dsohandle","#else","#elseif","#endif","#error","#file","#fileID","#fileLiteral","#filePath","#function","#if","#imageLiteral","#keyPath","#line","#selector","#sourceLocation","#warning"],Re=["abs","all","any","assert","assertionFailure","debugPrint","dump","fatalError","getVaList","isKnownUniquelyReferenced","max","min","numericCast","pointwiseMax","pointwiseMin","precondition","preconditionFailure","print","readLine","repeatElement","sequence","stride","swap","swift_unboxFromSwiftValueWithType","transcode","type","unsafeBitCast","unsafeDowncast","withExtendedLifetime","withUnsafeMutablePointer","withUnsafePointer","withVaList","withoutActuallyEscaping","zip"],De=b(/[/=\-+!*%<>&|^~?]/,/[\u00A1-\u00A7]/,/[\u00A9\u00AB]/,/[\u00AC\u00AE]/,/[\u00B0\u00B1]/,/[\u00B6\u00BB\u00BF\u00D7\u00F7]/,/[\u2016-\u2017]/,/[\u2020-\u2027]/,/[\u2030-\u203E]/,/[\u2041-\u2053]/,/[\u2055-\u205E]/,/[\u2190-\u23FF]/,/[\u2500-\u2775]/,/[\u2794-\u2BFF]/,/[\u2E00-\u2E7F]/,/[\u3001-\u3003]/,/[\u3008-\u3020]/,/[\u3030]/),Ie=b(De,/[\u0300-\u036F]/,/[\u1DC0-\u1DFF]/,/[\u20D0-\u20FF]/,/[\uFE00-\uFE0F]/,/[\uFE20-\uFE2F]/),Be=p(De,Ie,"*"),Le=b(/[a-zA-Z_]/,/[\u00A8\u00AA\u00AD\u00AF\u00B2-\u00B5\u00B7-\u00BA]/,/[\u00BC-\u00BE\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF]/,/[\u0100-\u02FF\u0370-\u167F\u1681-\u180D\u180F-\u1DBF]/,/[\u1E00-\u1FFF]/,/[\u200B-\u200D\u202A-\u202E\u203F-\u2040\u2054\u2060-\u206F]/,/[\u2070-\u20CF\u2100-\u218F\u2460-\u24FF\u2776-\u2793]/,/[\u2C00-\u2DFF\u2E80-\u2FFF]/,/[\u3004-\u3007\u3021-\u302F\u3031-\u303F\u3040-\uD7FF]/,/[\uF900-\uFD3D\uFD40-\uFDCF\uFDF0-\uFE1F\uFE30-\uFE44]/,/[\uFE47-\uFEFE\uFF00-\uFFFD]/),ze=b(Le,/\d/,/[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/),$e=p(Le,ze,"*"),Fe=p(/[A-Z]/,ze,"*"),je=["attached","autoclosure",p(/convention\(/,b("swift","block","c"),/\)/),"discardableResult","dynamicCallable","dynamicMemberLookup","escaping","freestanding","frozen","GKInspectable","IBAction","IBDesignable","IBInspectable","IBOutlet","IBSegueAction","inlinable","main","nonobjc","NSApplicationMain","NSCopying","NSManaged",p(/objc\(/,$e,/\)/),"objc","objcMembers","propertyWrapper","requires_stored_property_inits","resultBuilder","Sendable","testable","UIApplicationMain","unchecked","unknown","usableFromInline","warn_unqualified_access"],Pe=["iOS","iOSApplicationExtension","macOS","macOSApplicationExtension","macCatalyst","macCatalystApplicationExtension","watchOS","watchOSApplicationExtension","tvOS","tvOSApplicationExtension","swift"]
...
end:/"""/,relevance:2},x={scope:"subst",begin:/\{/,end:/\}/,keywords:a},A={
scope:"string",begin:/\$"/,end:/"/,contains:[{match:/\{\{/},{match:/\}\}/
},e.BACKSLASH_ESCAPE,x]},O={scope:"string",begin:/(\$@|@\$)"/,end:/"/,
...
};return x.contains=[O,A,N,v,S,n,i,r,_,E,y,w,o,d],{name:"F#",
aliases:["fs","f#"],keywords:a,illegal:/\/\*/,classNameAliases:{
"computation-expression":"keyword"},contains:[n,{variants:[M,O,A,k,N,v,S]
...
end:"$",illegal:"\n"},c]}},grmr_latex:e=>{const n=[{begin:/\^{6}[0-9a-f]{6}/},{
...
contains:[m()]})),d("mintinline",l(o,{contains:[p(),m()]})),d("url",{
contains:[p("link"),p("link")]}),d("hyperref",{contains:[p("link")]
}),d("href",l(c,{contains:[p("link")]
})),...[].concat(...["","\\*"].map((e=>[g("verbatim"+e,u("verbatim"+e)),g("filecontents"+e,l(o,u("filecontents"+e))),...["","B","L"].map((n=>g(n+"Verbatim"+e,l(c,u(n+"Verbatim"+e)))))]))),g("minted",l(c,l(o,u("minted")))),...t]
}},grmr_less:e=>{
const n=ae(e),t=le,a="[\\w-]+",i="("+a+"|@\\{"+a+"\\})",r=[],s=[],o=e=>({
...
contains:["self"]}),a=[e.C_LINE_COMMENT_MODE,t],i={match:[/\./,b(...xe,...Ae)],
className:{2:"keyword"}},r={match:p(/\./,b(...Me)),relevance:0
},s=Me.filter((e=>"string"==typeof e)).concat(["_|0"]),o={variants:[{
className:"keyword",
match:b(...Me.filter((e=>"string"!=typeof e)).concat(Oe).map(ke),...Ae)}]},c={
$pattern:b(/\b\w+/,/#\w+/),keyword:s.concat(Te),literal:Se},l=[i,r,o],d=[{
match:p(/\./,b(...Re)),relevance:0},{className:"built_in",
match:p(/\b/,b(...Re),/(?=\()/)}],m={match:/->/,relevance:0},u=[m,{
className:"operator",relevance:0,variants:[{match:Be},{match:`\\.(\\.|${Ie})+`}]
...
contains:x},O=e=>{const n=p(e,/\//),t=p(/\//,e);return{begin:n,end:t,
contains:[...x,{scope:"comment",begin:`#(?!.*${t})`,end:/$/}]}},M={
scope:"regexp",variants:[O("###"),O("##"),O("#"),A]},S={match:p(/`/,$e,/`/)
...
scope:"keyword",match:p(/@/,b(...je),g(b(/\(/,/\s+/)))},{scope:"meta",
match:p(/@/,$e)}],R={match:g(/\b[A-Z]/),relevance:0,contains:[{className:"type",
match:p(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/,ze,"+")
},{className:"type",match:Fe,relevance:0},{match:/[?!]+/,relevance:0},{
match:/\.\.\./,relevance:0},{match:p(/\s+&\s+/,g(Fe)),relevance:0}]},D={
...
},...a,M,...l,...d,...u,h,k,...C,...T,R]},B={begin:/</,end:/>/,
keywords:"repeat each",contains:[...a,R]},L={begin:/\(/,end:/\)/,keywords:c,
...
3:"title.function"},contains:[B,L,n],illegal:[/\[/,/%/]},$={
match:[/\b(?:subscript|init[?!]?)/,/\s*(?=[<(])/],className:{1:"keyword"},
contains:[B,L,n],illegal:/\[|%/},F={match:[/operator/,/\s+/,Be],className:{
1:"keyword",3:"title"}},j={begin:[/precedencegroup/,/\s+/,Fe],className:{
1:"keyword",3:"title"},contains:[R],keywords:[...Ce,...Se],end:/}/},P={
begin:[/(struct|protocol|class|extension|enum|actor)/,/\s+/,$e,/\s*/],
beginScope:{1:"keyword",3:"title.class"},keywords:c,contains:[B,...l,{begin:/:/,
end:/\{/,keywords:c,contains:[{scope:"title.class.inherited",match:Fe},...l],
...
contains:["self",...t]}]}return{name:"Swift",keywords:c,contains:[...a,z,$,{
match:[/class\b/,/\s+/,/func\b/,/\s+/,/\b[A-Za-z_][A-Za-z0-9_]*\b/],scope:{
1:"keyword",3:"keyword",5:"title.function"}},{match:[/class\b/,/\s+/,/var\b/],
scope:{1:"keyword",3:"keyword"}},P,F,j,{beginKeywords:"import",end:/$/,
contains:[...a],relevance:0},M,...l,...d,...u,h,k,...C,...T,R,I]}},
grmr_typescript:e=>{
const n=e.regex,t=Ne(e),a=be,i=["any","void","number","boolean","string","object","never","symbol","bigint","unknown"],r={
...
literal:fe,built_in:ve.concat(i),"variable.language":we},c={className:"meta",
...
aliases:["yml"],contains:c}}});const qe=te;for(const e of Object.keys(Ue)){
const n=e.replace("grmr_","").replace("_","-");qe.registerLanguage(n,Ue[e])}
return qe}()
